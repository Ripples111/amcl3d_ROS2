...
public:
   ...
   */
  bool buildGridSliceMsg(const double z, nav_msgs::msg::OccupancyGrid& msg) const;
   ...
   */
  bool buildMapPointCloudMsg(sensor_msgs::msg::PointCloud2& msg) const;
...
private:
  ...
  std::shared_ptr<amcl3d::Grid3d> Grid3d_;
};
