...
#include "geometry_msgs/msg/point32.hpp"  // ROS 2格式[^24^]
#include "geometry_msgs/msg/pose_array.hpp"  // ROS 2格式[^26^]
#include "geometry_msgs/msg/pose_with_covariance_stamped.hpp"  // ROS 2格式[^25^]
...
public:
   ...
   */
  void buildParticlesPoseMsg(geometry_msgs::msg::PoseArray& msg) const;
...
private:
  ...
  std::shared_ptr<amcl3d::ParticleFilter> particle_filter_;
};
