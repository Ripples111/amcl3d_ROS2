...
{
  //particle_filter_ = std::make_shared<amcl3d::ParticleFilter>(this);
}
...
void ParticleFilter::buildParticlesPoseMsg(geometry_msgs::msg::PoseArray& msg) const
{
                            ...
                            const double roll, const double pitch)
{
  ...
  //RCLCPP_DEBUG(this->get_logger(),"Update time 1: [%lf] sec", elapsed_secs);
